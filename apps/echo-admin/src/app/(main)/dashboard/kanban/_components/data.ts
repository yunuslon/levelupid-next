...
export const initialBoard: BoardState = {
  ideas: [
    {
      ...
      description:
        'Model Tender, Award/L1, Work Order, allocation, salary, and documents.',
      priority: 'High',
      dueDate: 'Jun 14',
      progress: 10,
    ...
    },
    {
      ...
      description:
        'Compare private MVP, open core, GPL, AGPL, and commercial modules.',
      priority: 'Medium',
      dueDate: 'Jun 16',
      progress: 20,
    ...
    },
    {
      ...
      description:
        'Define local database backup, restore, and exported document recovery.',
      priority: 'Medium',
      dueDate: 'Jun 18',
      progress: 15,
  ...
  planned: [
    {
      ...
      description:
        'Create local-first desktop shell with React, Tailwind, and shadcn/ui.',
      priority: 'High',
      dueDate: 'Jun 20',
      progress: 25,
      owner: taskOwners.arham,
    ...
    },
    {
      ...
      description:
        'Expose renderer-safe methods for imports, records, PDFs, and backups.',
      priority: 'High',
      dueDate: 'Jun 22',
      progress: 20,
    ...
    },
    {
      ...
      description:
        'Create local records for clients, contractors, employees, and identifiers.',
      priority: 'Medium',
      dueDate: 'Jun 24',
      progress: 15,
      owner: taskOwners.meera,
  ...
  building: [
    {
      ...
      description:
        'Model parties, employees, tenders, work orders, salary imports, and documents.',
      priority: 'High',
      dueDate: 'Jun 26',
      progress: 65,
      owner: taskOwners.arham,
    ...
    },
    {
      ...
      description:
        'Read salary sheets with SheetJS and persist import batches locally.',
      priority: 'High',
      dueDate: 'Jun 28',
      progress: 45,
    ...
    },
    {
      ...
      description:
        'Map Excel columns to salary fields with reusable templates per party.',
      priority: 'Medium',
      dueDate: 'Jul 1',
      progress: 30,
  ...
  qa: [
    ...
    },
    {
      ...
      description:
        'Preview generated payslips before bulk PDF export and document history.',
      priority: 'Medium',
      dueDate: 'Jul 6',
      progress: 60,
      owner: taskOwners.junaid,
  ...
  shipped: [
    {
      ...
      description:
        'Renderer stays UI-only; preload, IPC, services, and database stay separated.',
      priority: 'High',
      dueDate: 'Jun 8',
      progress: 100,
      owner: taskOwners.arham,
    ...
    },
    {
      ...
      description:
        'Start private source first, then revisit open-core after workflow validation.',
      priority: 'Medium',
      dueDate: 'Jun 10',
      progress: 100,
      owner: taskOwners.rahul,
    ...
    },
    {
      ...
      description:
        'Payslip generation is first, but data model supports wider tender operations.',
      priority: 'Medium',
      dueDate: 'Jun 12',
      progress: 100,
      owner: taskOwners.meera,
